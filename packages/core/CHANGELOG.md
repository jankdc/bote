...
- 38ffe74: Ship `@standard-schema/spec` as a regular dependency instead of declaring it as
...
- 12cfadf: add more documentation around the API, especially around IterStream
- Updated dependencies [a102b48]
- Updated dependencies [1b78b1e]
  - @botejs/native@0.9.0
...
- b608d30: Remove redundant 'seekable' property in Reader.
